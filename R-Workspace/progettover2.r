...
train_y_1 <-train_x_1[721,]
train_x_1 <- train_x_1[-721,]

train_y_1 <-t(train_y_1)
train_x_1 <- t(train_x_1)

test_y_1 <- anal$Ana5[721,] 
test_x_1 <- anal$Ana5[-721,] 

test_y_1 <-t(test_y_1)
test_x_1 <- t(test_x_1)

train_x_2 <- cbind(anal$Ana1, anal$Ana2, anal$Ana3, anal$Ana5)
train_y_2 <-train_x_2[721,]
train_x_2 <- train_x_2[-721,]

train_y_2 <-t(train_y_2)
train_x_2 <- t(train_x_2)

test_y_2 <- anal$Ana4[721,] 
test_x_2 <- anal$Ana4[-721,] 

test_y_2 <-t(test_y_2)
test_x_2 <- t(test_x_2)

train_x_3 <- cbind(anal$Ana1, anal$Ana2, anal$Ana4, anal$Ana5)
train_y_3 <-train_x_3[721,]
train_x_3 <- train_x_3[-721,]

train_y_3 <-t(train_y_3)
train_x_3 <- t(train_x_3)

test_y_3 <- anal$Ana3[721,] 
test_x_3 <- anal$Ana3[-721,] 

test_y_3 <-t(test_y_3)
test_x_3 <- t(test_x_3)

train_x_4 <- cbind(anal$Ana1, anal$Ana3, anal$Ana4, anal$Ana5)
train_y_4 <-train_x_4[721,]
train_x_4 <- train_x_4[-721,]

train_y_4 <-t(train_y_4)
train_x_4 <- t(train_x_4)

test_y_4 <- anal$Ana2[721,] 
test_x_4 <- anal$Ana2[-721,] 

test_y_4 <-t(test_y_4)
test_x_4 <- t(test_x_4)

train_x_5 <- cbind(anal$Ana2, anal$Ana3, anal$Ana4, anal$Ana5)
train_y_5 <-train_x_5[721,]
train_x_5 <- train_x_5[-721,]

train_y_5 <-t(train_y_5)
train_x_5 <- t(train_x_5)

test_y_5 <- anal$Ana1[721,] 
test_x_5 <- anal$Ana1[-721,] 
...
Data_Name <- Dataset_finale_T[1:606,721]

Dataset_finale_T[,721] <- NULL
